"""Generate runnable MLIR-AIE for packet-source to multicast-bridge cases."""
...
{chr(10).join(flows)}
    ...
    func.func private @bridge_init_summary(memref<{SUMMARY_DWORDS}xi32>, i32, i32) attributes {{link_with = "{experiment_dir}/dataflow_kernels.o"}}
    func.func private @bridge_accum_chunk(memref<{MAIN_CHUNK_DWORDS}xi32>, memref<{SUMMARY_DWORDS}xi32>, i32) attributes {{link_with = "{experiment_dir}/dataflow_kernels.o"}}

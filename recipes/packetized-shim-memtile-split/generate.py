"""Generate raw MLIR-AIE for packetized shim-to-memtile split routing."""

import os
from pathlib import Path

VARIANT = os.environ.get("PACKET_SPLIT_VARIANT", "full")
if VARIANT == "onecol":
    MAIN_COLUMNS = (2,)
    EDGE_COLUMNS = (0,)
elif VARIANT == "full":
    ...
    raise ValueError(f"unsupported PACKET_SPLIT_VARIANT={VARIANT!r}")

#!/usr/bin/env python3
"""Run exp60 on real NPU and verify MyLM chunk-ring projection."""
...
def run_on_npu() -> bool:
    print("=" * 78)
    print("Experiment 60: MyLM Chunk-Ring Projection")
    print("=" * 78)
    ...
    if mismatch.size == 0:
        print("  PASS: exact MyLM patch descriptors feed row1 small chunk rings and MyLM-shaped main inputs.")
        return True

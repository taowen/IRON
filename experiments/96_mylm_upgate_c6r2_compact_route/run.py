#!/usr/bin/env python3
"""Audit the row1 compact route that feeds c6r2 up/gate slices."""
...
DEFAULT_OUT = Path("/tmp/iron_exp96_mylm_upgate_c6r2_compact_route")
...
def main() -> None:
    ...
    summary = args.out / "upgate_c6r2_compact_route.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_upgate_c6r2_compact_route.py"),
            "--cdo-csv",

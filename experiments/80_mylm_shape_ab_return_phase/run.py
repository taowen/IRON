#!/usr/bin/env python3
"""Audit MyLM shape-A/B hidden handoff and return-window phase order."""
...
DEFAULT_OUT = Path("/tmp/iron_exp80_mylm_shape_ab_return_phase")
EXP70_OUT = Path("/tmp/iron_exp70_mylm_path_replay")
EDGE_TILES = "c0r2,c0r3,c0r4,c0r5,c1r3,c6r2,c7r2,c7r3,c7r4,c7r5"
...
def main() -> None:
    ...
    summary = args.out / "shape_ab_return_phase_summary.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_shape_ab_return_phase_summary.py"),
            cdo_csv,
            "--bd-csv",
            bd_csv,
            "--disasm-dir",

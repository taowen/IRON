#!/usr/bin/env python3
"""Audit Shape-A/B hidden-carrier lane/block usage."""
...
DEFAULT_OUT = Path("/tmp/iron_exp93_mylm_shape_ab_carrier_lane_usage")
...
def main() -> None:
    ...
    summary = args.out / "shape_ab_carrier_lane_usage.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_shape_ab_carrier_lane_usage.py"),
            "--disasm-dir",
            disasm_dir,
        ],
        cwd=args.mylm,

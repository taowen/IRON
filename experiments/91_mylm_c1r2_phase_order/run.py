#!/usr/bin/env python3
"""Audit MyLM c1r2 full-vector phase order."""
...
DEFAULT_OUT = Path("/tmp/iron_exp91_mylm_c1r2_phase_order")
...
def main() -> None:
    ...
    summary = args.out / "c1r2_phase_order.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_c1r2_phase_order_summary.py"),
            "--cdo-csv",
            layer_dir / "layer_cdo.csv",
            "--bd-csv",
            layer_dir / "layer_bd.csv",
            "--txn-dump",
            layer_dir / "qwen3_layer_L31.dump",
            "--disasm-dir",
            disasm_dir,
        ],
        cwd=args.mylm,

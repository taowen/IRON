"""CPU reference for exp 13: fat-chunk weight layout (row0+row1 per chunk, grouped by column)."""
...
def pack_all_weights_fat(all_scales, all_zeros, all_int4):
    ...
    Per column: NUM_PROJ * NUM_CHUNKS fat chunks
...
def projection_column_reference(packed_all, activation):
    """Full reference. Output layout: [col0_r0_p0 | col0_r0_p1 | col0_r1_p0 | col0_r1_p1 | col1_...]"""
...
if __name__ == "__main__":
    ...
    print(f"Config: {NUM_COLS} cols x {ROWS_PER_COL} rows x {NUM_PROJECTIONS} proj")
    ...
    print(f"\nOutput[0:4] (col0_r0_p0): {output[:4]}")
    print(f"Output[32:36] (col0_r0_p1): {output[32:36]}")

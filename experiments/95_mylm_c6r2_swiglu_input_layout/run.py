#!/usr/bin/env python3
"""Audit c6r2 SwiGLU input half layout."""
...
DEFAULT_OUT = Path("/tmp/iron_exp95_mylm_c6r2_swiglu_input_layout")
...
def main() -> None:
    ...
    summary = args.out / "c6r2_swiglu_input_layout.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_c6r2_swiglu_input_layout.py"),
            "--bd-csv",

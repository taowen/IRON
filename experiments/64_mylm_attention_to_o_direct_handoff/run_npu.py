#!/usr/bin/env python3
"""Run exp64 on real NPU and verify attention-to-O direct handoff."""
...
def run_on_npu() -> bool:
    print("=" * 78)
    print("Experiment 64: MyLM Attention-To-O Direct Handoff")
    print("=" * 78)
    ...
    print("  Preparing packetized O weights and attention-slice CPU reference...")

#!/usr/bin/env python3
"""Run exp67 on real NPU and verify the global QKV/O layout contract."""
...
def run_on_npu() -> bool:
    print("=" * 78)
    print("Experiment 67: MyLM Global QKV/O Layout Contract")
    print("=" * 78)
    ...
    if mismatch.size == 0:
        print(
            ...
            "packetized MyLM patch queues with the global QKV/O layout contract."
        )
        return True

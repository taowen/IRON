#!/usr/bin/env python3
"""Audit MyLM main16 phase records and Q-window distributor."""
...
DEFAULT_OUT = Path("/tmp/iron_exp85_mylm_main16_phase_record")
...
def main() -> None:
    ...
    summary = args.out / "main16_phase_record_summary.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_main16_phase_record_summary.py"),
            "--bd-csv",

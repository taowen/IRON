#!/usr/bin/env python3
"""Audit Shape-A/B hidden carrier aliases and lock ownership."""
...
DEFAULT_OUT = Path("/tmp/iron_exp84_mylm_shape_ab_carrier_lock")
EXP70_OUT = Path("/tmp/iron_exp70_mylm_path_replay")
DISASM_TILES = "c0r2,c0r3,c0r4,c0r5,c7r2,c7r3,c7r4,c7r5"
...
def main() -> None:
    ...
    summary = args.out / "shape_ab_carrier_lock_summary.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_shape_ab_carrier_lock_summary.py"),
            "--disasm-dir",
            disasm_dir,
        ],
        cwd=args.mylm,

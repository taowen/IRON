#!/usr/bin/env python3
"""Audit MyLM packet2 attention-output bridge into main16 O input."""
...
DEFAULT_OUT = Path("/tmp/iron_exp82_mylm_attention_o_bridge")
...
def main() -> None:
    ...
    summary = args.out / "attention_o_bridge_summary.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_attention_o_bridge_summary.py"),
            cdo_csv,
            "--bd-csv",
            bd_csv,
        ],

#!/usr/bin/env python3
"""Audit MyLM row1 rounded-history split into shape-A/shape-B consumers."""
...
DEFAULT_OUT = Path("/tmp/iron_exp79_mylm_row1_history_split")
...
def main() -> None:
    ...
    summary = args.out / "row1_history_split_summary.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_row1_history_split_summary.py"),
            cdo_csv,
            "--bd-csv",
            bd_csv,
            "--trace-csv",

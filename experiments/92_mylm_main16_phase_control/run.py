#!/usr/bin/env python3
"""Audit MyLM main16 phase control words and replay counts."""
...
DEFAULT_OUT = Path("/tmp/iron_exp92_mylm_main16_phase_control")
...
def main() -> None:
    ...
    summary = args.out / "main16_phase_control.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_main16_phase_control_summary.py"),
            "--disasm-dir",
            disasm_dir,
            "--tile",
            "c2r2",

#!/usr/bin/env python3
"""Audit Shape-A/B hidden-carrier block phase order."""
...
DEFAULT_OUT = Path("/tmp/iron_exp87_mylm_shape_ab_carrier_block_order")
EXP70_OUT = Path("/tmp/iron_exp70_mylm_path_replay")
DISASM_TILES = "c0r2,c0r3,c0r4,c0r5,c7r2,c7r3,c7r4,c7r5,c2r2"
...
def main() -> None:
    ...
    summary = args.out / "shape_ab_carrier_block_order.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_shape_ab_carrier_block_order.py"),
            "--disasm-dir",
            disasm_dir,
        ],
        cwd=args.mylm,

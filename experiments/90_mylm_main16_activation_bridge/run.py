#!/usr/bin/env python3
"""Audit MyLM packet0/packet2 activation bridges into main16 input rings."""
...
DEFAULT_OUT = Path("/tmp/iron_exp90_mylm_main16_activation_bridge")
...
def main() -> None:
    ...
    summary = args.out / "main16_activation_bridge.txt"
    run(
        [
            "python3",
            mylm_tool(args.mylm, "aie_main16_activation_bridge_summary.py"),

"""Test: 2-core with gathered_full pre-initialized (bypass lock wait)."""
...
def main():
    print("Generating MLIR (2-core preload)...")
    from generate_2core_preload import generate_mlir
    mlir_text = generate_mlir()

    build_dir = EXPERIMENT_DIR / "build_2core_preload"
    ...
    print("\nPASS: Pre-loaded gathered works (memtile→shim is fine)")
    return True

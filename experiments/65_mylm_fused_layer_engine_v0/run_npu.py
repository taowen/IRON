#!/usr/bin/env python3
"""Run exp65 on real NPU and verify the fused layer engine v0 contract."""
...
def run_on_npu() -> bool:
    print("=" * 78)
    print("Experiment 65: MyLM Fused Layer Engine V0")
    print("=" * 78)
    ...
    print("  O phase activation source: deterministic attention-result handoff")
    ...
    if mismatch.size == 0:
        print(
            ...
            "packetized MyLM patch queues with direct attention-result-to-O handoff."
        )
        return True

...
#ifndef NEW_MEGA_HEAD_DIM
#define NEW_MEGA_HEAD_DIM 128
#endif

#ifndef NEW_MEGA_CHUNK_SIZE
#define NEW_MEGA_CHUNK_SIZE 64
#endif
...
void new_mega_fixed_attention_init_f32(float *__restrict state, float *__restrict acc, int32_t head_dim)
{
    event0();
...
void new_mega_fixed_attention_update_packed_bf16(const bfloat16 *__restrict q_full,
...
void new_mega_fixed_attention_finalize_into_full_bf16(const float *__restrict state,

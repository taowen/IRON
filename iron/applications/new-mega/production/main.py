...
def main() -> None:
    ...
    if result.errors == 0 and result.qwen3_errors == 0:
        ...
        print(
            ...
            "using two sequential head groups per lane, o_proj computes "
            "same-fabric-group partial contributions on each lane and reduces "
            "them through fixed group reducer Workers before finalizing local "
            "attention residual rows, "

...
def main() -> None:
    ...
    if result.errors == 0 and result.qwen3_errors == 0:
        ...
        print(
            ...
            f"chunks and emits {op.ffn_reduce_group_count} 32-row down-partial "
            "groups through the reducer fabric, "
            "down_proj computes real layer residual shards while reading "
            f"reduced down partial sums covering the first {op.ffn_npu_rows} "
            "FFN rows plus host-packed remaining rows, "

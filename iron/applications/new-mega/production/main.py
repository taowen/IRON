...
def main() -> None:
    ...
    if result.errors == 0 and result.qwen3_errors == 0:
        ...
        print(
            ...
            "chunks and emits four 32-row FFN partial groups through the "
            "reducer fabric, "
            "down_proj computes real layer residual shards while reading "
            "the first 128 FFN hidden rows reduced from the preceding gate_up "
            "phases and host-packed rows 128..3071, "

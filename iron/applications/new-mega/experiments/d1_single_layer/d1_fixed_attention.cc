...
#ifndef D1_HEAD_DIM
#define D1_HEAD_DIM 128
#endif

#ifndef D1_CHUNK_SIZE
#define D1_CHUNK_SIZE 64
#endif

#ifndef D1_ATTN_SCALE
#define D1_ATTN_SCALE 0.08838834764831845f
#endif
...
void d1_fixed_attention_init_f32(float *__restrict state, float *__restrict acc, int32_t head_dim)
{
    event0();
...
void d1_fixed_attention_update_packed_bf16(const bfloat16 *__restrict q_full,
                                           ...
                                           int32_t head_dim)
{
    ...
    for (int32_t row = 0; row < chunk_size; row++) {
        ...
        float score = aie::reduce_add(dot.template to_vector<float>()) * D1_ATTN_SCALE;
...
void d1_fixed_attention_finalize_into_full_bf16(const float *__restrict state,
